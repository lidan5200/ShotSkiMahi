    ...
    public class MesApiService : IDisposable
    {
        ...
        public async Task<Models.ApiResponse> StartAsync(string sfc)
        {
            ...
            try
            {
                ...
                (response, statusCode, responseBody) = await ExecuteGetRequest(requestUrl);
                sw.Stop();

                CreateAndLogApiEntry("Start", originalUrl, paramObject, response, statusCode, responseBody, sw.ElapsedMilliseconds);
            ...
            {
                sw.Stop();
                CreateAndLogApiEntry("Start", originalUrl, paramObject,
                    new Models.ApiResponse { Success = false, Message = ex.Message },
                    null, $"异常: {ex.Message}", sw.ElapsedMilliseconds, true, ex);
        ...
        public async Task<Models.ApiResponse> GetSfcKeyAsync(string magnetCode)
        {
            ...
            try
            {
                ...
                CreateAndLogApiEntry("GetSfcKey", originalUrl, paramObject, response, statusCode, responseBody, sw.ElapsedMilliseconds);
            ...
            {
                sw.Stop();
                CreateAndLogApiEntry("GetSfcKey", originalUrl, paramObject,
                    new Models.ApiResponse { Success = false, Message = ex.Message },
                    null, $"异常: {ex.Message}", sw.ElapsedMilliseconds, true, ex);
                return new Models.ApiResponse { Success = false, Message = ex.Message };
            }
        ...
        public async Task<Models.ApiResponse> AddSfcKeyAsync(string sfc, string magnetCode)
        {
            ...
            try
            {
                ...
                CreateAndLogApiEntry("AddSfcKey", originalUrl, paramObject, response, statusCode, responseBody, sw.ElapsedMilliseconds);
            ...
            {
                sw.Stop();
                CreateAndLogApiEntry("AddSfcKey", originalUrl, paramObject,
                    new Models.ApiResponse { Success = false, Message = ex.Message },
                    null, $"异常: {ex.Message}", sw.ElapsedMilliseconds, true, ex);
                return new Models.ApiResponse { Success = false, Message = ex.Message };
            }
        ...
        public async Task<Models.ApiResponse> TestDataCollect2MainChildAsync(string sfc, int pressTime, int pressTemp)
        {
            ...
            try
            {
                ...
                CreateAndLogApiEntry("TestDataCollect2MainChild", originalUrl, paramObject, response, statusCode, responseBody, sw.ElapsedMilliseconds);
            ...
            {
                sw.Stop();
                CreateAndLogApiEntry("TestDataCollect2MainChild", originalUrl, paramObject,
                    new Models.ApiResponse { Success = false, Message = ex.Message },
                    null, $"异常: {ex.Message}", sw.ElapsedMilliseconds, true, ex);
                return new Models.ApiResponse { Success = false, Message = ex.Message };
            }
        ...
        public async Task<Models.ApiResponse> CompleteAsync(string sfc)
        {
            ...
            try
            {
                ...
                CreateAndLogApiEntry("Complete", originalUrl, paramObject, response, statusCode, responseBody, sw.ElapsedMilliseconds);
            ...
            {
                sw.Stop();
                CreateAndLogApiEntry("Complete", originalUrl, paramObject,
                    new Models.ApiResponse { Success = false, Message = ex.Message },
                    null, $"异常: {ex.Message}", sw.ElapsedMilliseconds, true, ex);
                return new Models.ApiResponse { Success = false, Message = ex.Message };
            }
        ...
        private void CreateAndLogApiEntry(
            ...
            bool isException = false, Exception? ex = null)
        {
            var entry = new LocalLogEntry
            {
                Timestamp = DateTime.Now,
                Category = isException ? "API_EXCEPTION" : (apiResponse.Success ? "API_SUCCESS" : "API_FAIL"),
                ApiName = apiName,
                FullUrl = originalUrl,
                RequestMethod = "GET",
                RequestBody = JsonConvert.SerializeObject(paramObject, Formatting.Indented),
                StatusCode = statusCode,
                ResponseBody = isException && ex != null 
                    ? $"{ex.GetType().Name}: {ex.Message}" 
                    : FormatBody(responseBody),
                ElapsedMs = elapsedMs,
                IsSuccess = !isException && apiResponse.Success,
                Message = isException && ex != null ? ex.Message : apiResponse.Message
            };
            ...
            if (isException)
            {
                ...
                if (ex != null) LogDebug($"[{apiName}] 异常堆栈:\n{ex.StackTrace}");
            }
